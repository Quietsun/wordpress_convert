...
class WordpressConvertSettingMenu extends WordpressConvertSetting {
	...
	public static function displaySetting(){
		...
		// 適用ボタン系
		if(!file_exists($contentManager->getThemeFile($contentManager->getContentHome())."index.php") || file_exists($contentManager->getContentHome()."index.html") && filemtime($contentManager->getThemeFile($contentManager->getContentHome())."index.php") < filemtime($contentManager->getContentHome()."index.html")){
