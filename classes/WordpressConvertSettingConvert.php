...
class WordpressConvertSettingConvert extends WordpressConvertSetting {
	...
	public static function displaySetting($labels, $types, $hints, $options){
		...
		echo "<p class=\"bwp-txt\">".__("Please point directory which contents uploaded with BiND.", WORDPRESS_CONVERT_PROJECT_CODE)."</p>";
		echo "<p class=\"bwp-txt\">".__("After finished settings, starting to convert BiND WordPress template to WordPress theme.", WORDPRESS_CONVERT_PROJECT_CODE)."<br>";
