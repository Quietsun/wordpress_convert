...
class WordpressConvertSettingConvert extends WordpressConvertSetting {
	...
	public static function displaySetting($labels, $types, $hints, $options){
		...
		echo "<br><div>".__("Please point directory which contents uploaded with BiND.", WORDPRESS_CONVERT_PROJECT_CODE)."</div><br>";
		echo "<div>".__("After finished settings, starting to convert BiND WordPress template to WordPress theme.", WORDPRESS_CONVERT_PROJECT_CODE)."</div>";
		echo "<div>".__("Please create directory and upload WordPress template generated by BiND to it because of directory installed WordPress as document root in the local directory.", WORDPRESS_CONVERT_PROJECT_CODE)."</div>";
		echo "<div>".__("You can set path of directory for template remove first of `slashes` in it.", WORDPRESS_CONVERT_PROJECT_CODE)."</div>";
